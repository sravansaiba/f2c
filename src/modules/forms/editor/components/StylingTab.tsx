...
export const StylingTab = ({ stylingOptions, setStylingOptions }: StylingTabProps) => {
  ...
  // Reset all styling options
const resetStyling = () => {
  // First, clear the uploaded images array to ensure no lingering references
  setUploadedImages([]);
  ...
  // Then reset the styling options - make sure to explicitly set backgroundImage to null
  setStylingOptions({
    fontFamily: "Arial",
    fontSize: "16px",
    labelFontSize: "14px",
